import { Popover as ChakraPopover, IconButton, Portal, type PopoverTriggerProps, type PopoverContentProps } from '@chakra-ui/react';
    ...
    <ChakraPopover.Root {...rest} positioning={{ ...rest.positioning, gutter: 4 }}>
      ...
      <Portal disabled={!portalled} container={portalRef}>
        <ChakraPopover.Positioner>
          <ChakraPopover.Content {...popoverContentProps} ref={ref} />
        </ChakraPopover.Positioner>
      </Portal>
    </ChakraPopover.Root>
  );
